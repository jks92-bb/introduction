...
<summary>📖상속(extends)</summary>

* **상속의 개념:** 하나의 클래스가 다른 클래스의 특성(멤버 변수 및 메서드)을 물려받아 그 특성을 공유하는 것을 의미합니다.
* **extends 키워드 사용:**  extends 키워드를 사용하여 상위 클래스(부모 클래스)를 지정하고, 하위 클래스(자식 클래스)가 상위 클래스의 멤버를 상속받습니다.
* **상위 클래스의 멤버 사용:** 하위 클래스에서는 상위 클래스의 public 및 protected 멤버에 직접 접근할 수 있습니다. private 멤버는 직접 접근할 수 없지만, public 또는 protected 메서드를 통해 간접적으로 사용할 수 있습니다.
